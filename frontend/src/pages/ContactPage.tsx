      ...
      <div className="max-w-6xl mx-auto mb-16">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-12">
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 text-center hover:shadow-xl transition">
            ...
            <p className="text-sm text-slate-500 mt-4">Mon-Fri, 9am-6pm EST</p>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 text-center hover:shadow-xl transition">
            ...
            <p className="text-slate-600 mb-4">Send us your questions or concerns</p>
            <a
              href="mailto:contact@medidata.com"
              className="text-lg font-semibold text-emerald-600 hover:text-emerald-700 transition break-all"
            >
              contact@medidata.com
            </a>
            <p className="text-sm text-slate-500 mt-4">Response within 24 hours</p>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 text-center hover:shadow-xl transition">
            ...
            <p className="text-slate-600 mb-4">When we're available</p>
            <div className="text-sm space-y-1">
              <p className="font-semibold text-slate-900">Mon - Fri: 9am - 6pm EST</p>
              <p className="font-semibold text-slate-900">Sat - Sun: 10am - 4pm EST</p>
            </div>
            <p className="text-sm text-slate-500 mt-4">Holiday hours may vary</p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid md:grid-cols-2 gap-12">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                ...
                <textarea
                  ...
                  required
                  rows={5}
                  className="w-full px-4 py-2 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-sky-500 focus:border-transparent transition resize-none"
          ...
          <div className="space-y-8">
            {/* FAQ Section */}
            <div className="bg-white rounded-lg shadow-lg p-8">
              <h2 className="text-2xl font-bold text-slate-900 mb-6">Quick Answers</h2>
              <div className="space-y-4">
                <div>
                  <h3 className="font-semibold text-slate-900 mb-2">How long does it take to get a response?</h3>
                ...
                <div className="h-px bg-slate-200" />
                <div>
                  <h3 className="font-semibold text-slate-900 mb-2">Do you have a physical office?</h3>
                  <p className="text-slate-600 text-sm">
            ...
            {/* Support Options */}
            <div className="bg-white rounded-lg shadow-lg p-8">
              <h2 className="text-2xl font-bold text-slate-900 mb-6">Other Ways to Get Help</h2>
