  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-slate-100 py-12 px-4 dark:from-slate-900 dark:to-slate-800">
      <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-lg p-8 md:p-12 dark:bg-slate-900 dark:shadow-none dark:border dark:border-slate-700">
        <h1 className="text-4xl font-bold text-slate-900 mb-2 dark:text-white">Privacy Policy</h1>
        ...
        <div className="prose prose-slate dark:prose-invert max-w-none space-y-8">
          ...
          {/* HIPAA Compliance */}
          <section>
            <h2 className="text-2xl font-bold text-slate-900 mt-8 mb-4 dark:text-white">2. HIPAA Compliance</h2>
            <p className="text-slate-700 leading-relaxed dark:text-slate-200">
            ...
            <h3 className="text-xl font-semibold text-slate-900 mt-6 mb-3 dark:text-white">2.1 What is HIPAA?</h3>
            <p className="text-slate-700 leading-relaxed dark:text-slate-200">
            ...
            <h3 className="text-xl font-semibold text-slate-900 mt-6 mb-3 dark:text-white">2.2 Our HIPAA Commitments</h3>
          ...
          {/* Data Collection */}
          <section>
            <h2 className="text-2xl font-bold text-slate-900 mt-8 mb-4 dark:text-white">3. Information We Collect</h2>
            <p className="text-slate-700 leading-relaxed dark:text-slate-200">
              We collect various types of information to provide you with healthcare services and maintain our platform:
            </p>

            <h3 className="text-xl font-semibold text-slate-900 mt-6 mb-3 dark:text-white">3.1 Personal Health Information (PHI)</h3>
            <ul className="list-disc list-inside text-slate-700 space-y-2 ml-4 dark:text-slate-200">
            ...
            <h3 className="text-xl font-semibold text-slate-900 mt-6 mb-3 dark:text-white">3.2 Personally Identifiable Information (PII)</h3>
            <ul className="list-disc list-inside text-slate-700 space-y-2 ml-4 dark:text-slate-200">
            ...
            <h3 className="text-xl font-semibold text-slate-900 mt-6 mb-3 dark:text-white">3.3 Usage Information</h3>
            <ul className="list-disc list-inside text-slate-700 space-y-2 ml-4 dark:text-slate-200">
          ...
          {/* Data Security */}
          <section>
            <h2 className="text-2xl font-bold text-slate-900 mt-8 mb-4 dark:text-white">4. How We Protect Your Data</h2>
            <p className="text-slate-700 leading-relaxed dark:text-slate-200">
            ...
            <h3 className="text-xl font-semibold text-slate-900 mt-6 mb-3 dark:text-white">4.1 Technical Safeguards</h3>
            <ul className="list-disc list-inside text-slate-700 space-y-2 ml-4 dark:text-slate-200">
            ...
            <h3 className="text-xl font-semibold text-slate-900 mt-6 mb-3 dark:text-white">4.2 Administrative Safeguards</h3>
            <ul className="list-disc list-inside text-slate-700 space-y-2 ml-4 dark:text-slate-200">
            ...
            <h3 className="text-xl font-semibold text-slate-900 mt-6 mb-3 dark:text-white">4.3 Physical Safeguards</h3>
            <ul className="list-disc list-inside text-slate-700 space-y-2 ml-4 dark:text-slate-200">
          ...
          {/* Data Privacy */}
          <section>
            <h2 className="text-2xl font-bold text-slate-900 mt-8 mb-4 dark:text-white">5. Your Privacy Rights</h2>
            <p className="text-slate-700 leading-relaxed dark:text-slate-200">
              Under HIPAA and other privacy laws, you have the following rights regarding your health information:
            </p>

            <h3 className="text-xl font-semibold text-slate-900 mt-6 mb-3 dark:text-white">5.1 Right to Access</h3>
            <p className="text-slate-700 leading-relaxed dark:text-slate-200">
            ...
            <h3 className="text-xl font-semibold text-slate-900 mt-6 mb-3 dark:text-white">5.2 Right to Amendment</h3>
            <p className="text-slate-700 leading-relaxed dark:text-slate-200">
            ...
            <h3 className="text-xl font-semibold text-slate-900 mt-6 mb-3 dark:text-white">5.3 Right to Accounting of Disclosures</h3>
            <p className="text-slate-700 leading-relaxed dark:text-slate-200">
            ...
            <h3 className="text-xl font-semibold text-slate-900 mt-6 mb-3 dark:text-white">5.4 Right to Request Restrictions</h3>
            <p className="text-slate-700 leading-relaxed dark:text-slate-200">
            ...
            <h3 className="text-xl font-semibold text-slate-900 mt-6 mb-3 dark:text-white">5.5 Right to Confidential Communication</h3>
            <p className="text-slate-700 leading-relaxed dark:text-slate-200">
            ...
            <h3 className="text-xl font-semibold text-slate-900 mt-6 mb-3 dark:text-white">5.6 Right to Revoke Consent</h3>
            <p className="text-slate-700 leading-relaxed dark:text-slate-200">
          ...
          {/* Data Usage */}
          <section>
            <h2 className="text-2xl font-bold text-slate-900 mt-8 mb-4 dark:text-white">6. How We Use Your Information</h2>
            <p className="text-slate-700 leading-relaxed dark:text-slate-200">
            ...
            <h3 className="text-xl font-semibold text-slate-900 mt-6 mb-3 dark:text-white">6.1 Treatment</h3>
            <p className="text-slate-700 leading-relaxed dark:text-slate-200">
            ...
            <h3 className="text-xl font-semibold text-slate-900 mt-6 mb-3 dark:text-white">6.2 Payment</h3>
            <p className="text-slate-700 leading-relaxed dark:text-slate-200">
            ...
            <h3 className="text-xl font-semibold text-slate-900 mt-6 mb-3 dark:text-white">6.3 Healthcare Operations</h3>
            <p className="text-slate-700 leading-relaxed dark:text-slate-200">
            ...
            <h3 className="text-xl font-semibold text-slate-900 mt-6 mb-3 dark:text-white">6.4 Limited Other Uses</h3>
            <p className="text-slate-700 leading-relaxed dark:text-slate-200">
          ...
          {/* Data Sharing */}
          <section>
            <h2 className="text-2xl font-bold text-slate-900 mt-8 mb-4 dark:text-white">7. When We Disclose Your Information</h2>
            <p className="text-slate-700 leading-relaxed dark:text-slate-200">
              MediData only discloses your health information in specific circumstances required or permitted by HIPAA:
            </p>

            <h3 className="text-xl font-semibold text-slate-900 mt-6 mb-3 dark:text-white">7.1 With Your Authorization</h3>
            <p className="text-slate-700 leading-relaxed dark:text-slate-200">
            ...
            <h3 className="text-xl font-semibold text-slate-900 mt-6 mb-3 dark:text-white">7.2 To Healthcare Providers</h3>
            <p className="text-slate-700 leading-relaxed dark:text-slate-200">
            ...
            <h3 className="text-xl font-semibold text-slate-900 mt-6 mb-3 dark:text-white">7.3 For Legal Compliance</h3>
            <p className="text-slate-700 leading-relaxed dark:text-slate-200">
            ...
            <h3 className="text-xl font-semibold text-slate-900 mt-6 mb-3 dark:text-white">7.4 Business Associates</h3>
            <p className="text-slate-700 leading-relaxed dark:text-slate-200">
            ...
            <h3 className="text-xl font-semibold text-slate-900 mt-6 mb-3 dark:text-white">7.5 We Do NOT Share Your Information For:</h3>
            <ul className="list-disc list-inside text-slate-700 space-y-2 ml-4 dark:text-slate-200">
          ...
          {/* Data Retention */}
          <section>
            <h2 className="text-2xl font-bold text-slate-900 mt-8 mb-4 dark:text-white">8. Data Retention and Deletion</h2>
            <p className="text-slate-700 leading-relaxed dark:text-slate-200">
          ...
          {/* Breach Notification */}
          <section>
            <h2 className="text-2xl font-bold text-slate-900 mt-8 mb-4 dark:text-white">9. Breach Notification and Security Incidents</h2>
            <p className="text-slate-700 leading-relaxed dark:text-slate-200">
          ...
          <section>
            <h2 className="text-2xl font-bold text-slate-900 mt-8 mb-4 dark:text-white">10. Third-Party Services and Links</h2>
            <p className="text-slate-700 leading-relaxed dark:text-slate-200">
          ...
          {/* Children's Privacy */}
          <section>
            <h2 className="text-2xl font-bold text-slate-900 mt-8 mb-4 dark:text-white">11. Children's Privacy</h2>
            <p className="text-slate-700 leading-relaxed dark:text-slate-200">
          ...
          {/* Policy Changes */}
          <section>
            <h2 className="text-2xl font-bold text-slate-900 mt-8 mb-4 dark:text-white">12. Changes to This Privacy Policy</h2>
            <p className="text-slate-700 leading-relaxed dark:text-slate-200">
          ...
          {/* Contact Information */}
          <section>
            <h2 className="text-2xl font-bold text-slate-900 mt-8 mb-4 dark:text-white">13. Contact Us</h2>
            <p className="text-slate-700 leading-relaxed dark:text-slate-200">
          ...
          <section>
            <h2 className="text-2xl font-bold text-slate-900 mt-8 mb-4 dark:text-white">14. Regulatory Compliance and Certifications</h2>
            <p className="text-slate-700 leading-relaxed dark:text-slate-200">
